...
- [汇总指标 CSV](../../../outputs/paper/houston_2020/sensitivity/storage_scale/results/storage_scale_sensitivity.csv)
- [总运行成本对比图](../../../outputs/paper/houston_2020/sensitivity/storage_scale/figures/storage_scale_total_cost.png)
- [时移价值对比图](../../../outputs/paper/houston_2020/sensitivity/storage_scale/figures/storage_scale_shift_value.png)
- [运行元数据](../../../outputs/paper/houston_2020/sensitivity/storage_scale/run_metadata.json)
- [2 MWh / 0.5 MW 独立项目](../../../outputs/paper/houston_2020/sensitivity/storage_scale/experiments/energy_2p0_mwh_power_0p5_mw/)
- [4 MWh / 1 MW 独立项目](../../../outputs/paper/houston_2020/sensitivity/storage_scale/experiments/energy_4p0_mwh_power_1p0_mw/)
- [6 MWh / 1.5 MW 独立项目](../../../outputs/paper/houston_2020/sensitivity/storage_scale/experiments/energy_6p0_mwh_power_1p5_mw/)
